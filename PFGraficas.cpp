...
void idle(void){
  ...
  if(eTime > speed){
      ...
      for(i=0;i<totalshirtparticles;i++){
          ...
          numcap = -1;
          for(j=0;j<NUMCAPS;j++){
              handleColission(caps[j], shirtparticles[i].pos, shirtparticler);
              //if(colDetect(caps[j], shirtparticles[i].pos, shirtparticler) != 0){
//                  if(mincoll > colDetect(caps[j], shirtparticles[i].pos, shirtparticler)){
//                      mincoll = colDetect(caps[j], shirtparticles[i].pos, shirtparticler);
//                      numcap = j;
//                  }
//              }
//              if(numcap != -1){
//                  handleColission(caps[numcap], shirtparticles[i].pos, shirtparticler);//shirtparticles[i].mass);
//              }
          }
      }
      ...
      for(i=0;i<totalpantsparticles;i++){
          ...
          numcap = -1;
          for(j=0;j<NUMCAPS;j++){
              handleColission(caps[j], pantsparticles[i].pos, pantsparticler);
              //if(colDetect(caps[j], pantsparticles[i].pos, pantsparticler) != 0){
//                  if(mincoll > colDetect(caps[j], pantsparticles[i].pos, pantsparticler)){
//                      mincoll = colDetect(caps[j], pantsparticles[i].pos, pantsparticler);
//                      numcap = j;
//                  }
//              }
//              if(numcap != -1){
//                  handleColission(caps[numcap], pantsparticles[i].pos, pantsparticler);//pantsparticles[i].mass);
//              }
          }
      }
      ...
      for(i=0;i<totalhairparticles;i++){
          ...
          numcap = -1;
          for(j=0;j<NUMCAPS;j++){
              handleColission(caps[j], hairparticles[i].pos, hairparticler);
              //if(colDetect(caps[j], hairparticles[i].pos, hairparticler) != 0){
//                  if(mincoll > colDetect(caps[j], hairparticles[i].pos, hairparticler)){
//                      mincoll = colDetect(caps[j], hairparticles[i].pos, hairparticler);
//                      numcap = j;
//                  }
//              }
//              if(numcap != -1){
//                  handleColission(caps[numcap], hairparticles[i].pos, hairparticler);//hairparticles[i].mass);
//              }
          }
      }
  }
...
int initMenus(){
	int mainMenu, capMenu, jointMenu, skinMenu, shirtMenu, pantsMenu, hairMenu;
	...
	glutAddMenuEntry("Toggle Gravity",      4);
	...
	glutAddMenuEntry("Toggle Visibility",          61);
